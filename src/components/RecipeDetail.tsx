...
const RecipeDetail: React.FC = () => {
    ...
    return (
        <div className="recipe-container">
            ...
            <div className="recipe-summary" dangerouslySetInnerHTML={{__html: DOMPurify.sanitize(recipe.summary)}}/>
            ...
            <div className="recipe-time-container">
                <div>
                    ...
                    <div className="recipe-time-item">
                        ...
                        <div><p>{recipe.readyInMinutes} min</p></div>
                    </div>
                </div>
                <div>
                    ...
                    <div className="recipe-time-item">
                        ...
                        <div><p>{recipe.cookingMinutes} min</p></div>
                    </div>
                </div>
            </div>
            <div>
            ...
            <div className="recipe-instructions">
                ...
                <div className="recipe-instructions-info" dangerouslySetInnerHTML={{__html: DOMPurify.sanitize(recipe.instructions)}}/>
            </div>
